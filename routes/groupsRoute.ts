...
groupsRoute.post("/:groupid", isAuth, upload.single("uploaded_file"), validateUUID("groupid"), validateOptionalMessage ,validationErrorMiddleware, createMessageInGroup,  multerErrorMiddleware);
