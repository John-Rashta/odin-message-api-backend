...
import { validateConvoQuery, validateBodyUUID, validateOptionalMessage, validateOptionalUUID, validateUUID } from "../util/validators";
...
conversationsRoute.get("/:conversationid", isAuth, validateConvoQuery, validateUUID("conversationid"), validationErrorMiddleware, getConversation);
