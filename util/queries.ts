...
const getUserByName = async function getUserFromDatabaseByUsername(
  username: string,
) {
...
const findIfRequestExists = async function searchDatabaseIfRequestAlreadyExists(
  senderid: string,
  receiverid: string,
  type: Types,
) {
...
const getUserConversationsInfo =
  async function getAllOfUserConversationsFromDatabase(id: string) {
    const possibleUser = await prisma.user.findFirst({
      where: {
        id,
      },
...
const getAllUserRequests = async function getUserRequestsFromDatabase(
  id: string,
) {
  const possibleUser = await prisma.user.findFirst({
    where: {
...
const getGroupChatMembers = async function getParticipantsInGroupChat(
  id: string,
) {
...
const getUserSentRequests = async function getUserSentRequestsFromDatabase(
  id: string,
) {
  const possibleUser = await prisma.user.findFirst({
    where: {
...
const getGroupChatMessages = async function getGroupChatMessagesFromItsId(
  id: string,
) {
...
const getConvoInfo = async function getConvoInfoFromIds(
  userid: string,
  receiverid: string,
) {
...
const getConvoInfoFromId = async function getConvoInfoFromConvoId(
  convoid: string,
) {
  const possibleConvo = await prisma.conversations.findFirst({
    where: {
...
const checkIfGroupAdmin = async function checkIfUserIsAnAdminOfAGroupChat(
  userid: string,
  groupid: string,
) {
  const possibleGroup = await prisma.groupChat.findFirst({
...
const checkIfGroupMember = async function checkIfUserAlreadyAMemberOfGroupChat(
  userid: string,
  groupid: string,
) {
  const possibleGroup = await prisma.groupChat.findFirst({
...
const checkOwnerOfMessage = async function checkIfUserOwnsMessage(
  userid: string,
  messageid: string,
) {
...
const createRequest = async function createRequestBetweenUsers(
  senderid: string,
  receiverid: string,
  type: Types,
  sentAt: Date,
...
const createUser = async function createUserWithUsernameAndPassword(
  options: UserSign,
) {
...
const createGroupChat = async function createGroupChatForUser(
  userid: string,
  name = "New Group",
) {
...
const createConversation = async function createConversationBetweenUsers(
  userAid: string,
  userBid: string,
) {
...
const createFriendship = async function createFriendshipBetweenUsers(
  userAid: string,
  userBid: string,
) {
...
const createMessage = async function createMessageForGroupOrConvo(
  userid: string,
  sentAt: Date,
...
const updateMessage = async function updateMessageContent(
  messageid: string,
  content: string,
) {
...
const updateGroupInfo = async function updateGroupDetails(
  groupid: string,
  ...
  const updatedGroup = await prisma.groupChat.update({
    ...
    data: {
      ...
      (options.action === "ADD" || options.action === "REMOVE")
        ...
        : {}),
      ...(typeof options.memberid === "string" &&
      (options.action === "ADD" || options.action === "REMOVE")
        ? {
            members: {
              [optionsManager[options.action]]: {
...
const deleteFriendship = async function deleteFriendshipFromDatabase(
  friendshipid: string,
) {
...
const deleteGroup = async function deleteGroupChatFromDatabase(
  groupid: string,
) {
...
const deleteConversation = async function deleteConversationFromDatabase(
  convoid: string,
) {
...
const deleteRequest = async function deleteRequestFromDatabase(
  requestid: string,
) {
...
const deleteMessage = async function deleteMessageFromDatabase(
  messageid: string,
) {
...
const checkIfUsernameAvailable = async function checkIfUsernameAlreadyInUse(
  username: string,
) {
  const possibleUser = await prisma.user.findFirst({
    where: {
...
const checkIfFriendshipExists =
  async function checkIfFriendshipAlreadyExistsBetweenUsers(
    userAid: string,
    userBid: string,
  ) {
...
const checkIfConvoExistsByUsers =
  async function checkIfConversationAlreadyExistsBetweenUsers(
    userAid: string,
    userBid: string,
  ) {
    const possibleConvo = await prisma.conversations.findFirst({
...
const checkIfConvoIdValid = async function checkIfConversationExistsById(
  convoid: string,
) {
  const possibleConvo = await prisma.conversations.findFirst({
    where: {
...
const checkIfGroupExists = async function checkIfGroupChatExistsById(
  groupid: string,
) {
  const possibleGroup = await prisma.groupChat.findFirst({
    where: {
...
const checkIfUserRoleInRequest = async function checkIfUserSentTheRequest(
  userid: string,
  requestid: string,
  type: RequestTypes,
) {
...
const checkIfUserInRequest = async function checkIfUserSentTheRequest(
  userid: string,
  requestid: string,
) {
  const possibleRequest = await prisma.requests.findFirst({
...
const checkIfInConvo = async function checkIfUserInConversation(
  userid: string,
  convoid: string,
) {
  const possibleConvo = await prisma.conversations.findFirst({
...
const checkIfInFriendship = async function checkIfUserInFriendship(
  userid: string,
  friendshipid: string,
) {
  const possibleFriendship = await prisma.friendships.findFirst({
...
const getRequestInfo = async function getRequestInfoFromDatabase(
  requestid: string,
) {
  const possibleRequest = await prisma.requests.findFirst({
    where: {
...
const searchForUsers = async function searchForUsersByUsername(
  username: string,
) {
...
const changeOnlineStatus = async function changeOnlineStatusOfUser(
  userid: string,
  status: boolean,
) {
...
const checkAndReturnGroup = async function checkIfInGroupAndReturnAllInfo(
  userid: string,
  groupid: string,
) {
